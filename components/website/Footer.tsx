    ...
    <div>
        ...
        <div className="bg-[#70960c] pt-24 pb-6">
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <p className="mt-6 max-w-md leading-relaxed text-white font-medium sm:max-w-xs text-left">
                FabriCare is proudly a registered brand under Careplus Industries International Limited.
                </p>
                ...
                <div className="mt-8">
                    <p className="text-white text-base font-medium">Sign up for our newsletter to get updates and tips.</p>
                    <div className="mt-4">
                    {/* <Input type="email" placeholder="Enter your email" /> */}
                    <Input placeholder="Enter your email" className="w-full bg-white/20 border-none rounded-lg py-6! focus:ring-0 focus:outline-none placeholder:text-white placeholder:font-medium" />
                    <Button className="w-full bg-[#fee231] text-[#70960c] text-base font-bold rounded-lg py-6! focus:ring-0 focus:outline-none mt-4">Subscribe Now</Button>
                    </div>
                </div>
                </div>
                </div>
            ...
            <div className="mt-12 border-t border-white/20 pt-6">
                ...
                <p className="text-sm text-white font-medium">
                    <span className="block sm:inline mr-2">All rights reserved</span>
